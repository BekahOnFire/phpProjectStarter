<?php
     ...
     * Demonstrates logging to database log table.
     */
    ...
    echo $ptrWeb->showHeader("Example Reports Page");
    ...
    echo $ptrWeb->displayTypicalPage("Basic Reports Configuration","siteInputForm","basicReports.php");
    ...
    databaseLogWriter($ptrDb, $_SESSION["userid"], "basicReports page connect");
